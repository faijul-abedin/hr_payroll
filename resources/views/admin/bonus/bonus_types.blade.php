        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body row">
                    <form method="POST" action="{{ route('bonus.types.save') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('scale') is-invalid @enderror" name="scale" id="">
                                    @error('scale')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ route('bonus.types.delete', $bonus->id) }}" type="button" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
