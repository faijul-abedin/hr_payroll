        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body row">
                    <form method="POST" action="{{ route('reward.types.save') }}">
                        @csrf
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('reward.types.edit', $r->id) }}" class="btn btn-sm btn-success">{{ __('Edit') }}</a>
                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$r->id}}">delete</a>
                        </td>
                    </tr>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ route('reward.types.delete', $r->id) }}" type="button" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
